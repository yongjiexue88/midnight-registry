...
const caseCopies: Record<string, Partial<VisitorCopy>> = {
  ...
  "d1-han-parasite": {
    ...
    eyes: "棕色",
    hair: "黑色帽檐压得很低",
    feature: "蓝星维修臂章；衣领下方有轻微鼓动",
    clothing: "工具背心，密封工具箱，衣领潮湿",
    voice: "专业，但呼吸过重",
    behavior: "准确说出配电箱位置，却把黑色纤维咳进手套里",
    clues: ["工单与通行证看似正确。", "扫描器发现胸口有第二个热源。", "监控拍到颈后有细小开合结构。", "必须先封锁或净化，再呼叫安保。"],
    phone: "物业确认工单后压低声音：“别让湿的那个越过警戒线。”",
    scanner: "承包商证 BSR-443 匹配，但身体扫描在胸骨后方发现不可能的温热组织。",
    camera: "监控拍到他的后颈在衣领下开合。",
    question: "他把工单背得完全正确，却咳出一根逆着空气摆动的细线。",
  },
  "d1-li-real": {
    reason: "抱着包好的花回家",
    clothing: "绿色雨披，怀里是包好的百合",
    voice: "语气温和，明确拒绝乘电梯",
    behavior: "没等询问就走向楼梯，并纠正“李阿姨”称呼",
    clues: ["手链、走楼梯习惯和花束全部一致。", "她拒绝错误称呼。", "没有声音或倒影冲突。"],
  ...
  "d1-owen-fake": {
    ...
    clothing: "深蓝色长围巾",
    voice: "说完话才开始哼歌",
    behavior: "主动让你替他把琴盒拿上楼；琴盒被质疑后传出呼吸声",
    clues: ["证件号码错了一位。", "琴盒搭扣应为银色。", "徐欧文绝不让别人拿琴盒。", "琴盒里有另一个人的呼吸。"],
